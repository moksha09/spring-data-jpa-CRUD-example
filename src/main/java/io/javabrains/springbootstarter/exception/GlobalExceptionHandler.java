...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(NoSuchTopicExistsException.class)
	public ResponseEntity<?> resourceNotFoundHandling(NoSuchTopicExistsException exception, WebRequest request) {
